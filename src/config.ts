...
const ASSIGNMENT_COST_FULL_1D = -8;
const ASSIGNMENT_COST_HALF_1D = -2;
const ASSIGNMENT_COST_FULL_2D = -4;
const ASSIGNMENT_COST_HALF_2D = -1;
const ASSIGNMENT_COST_HALF_FULL_2D = -2;
const ASSIGNMENT_COST_PERPENDICULAR = -1;